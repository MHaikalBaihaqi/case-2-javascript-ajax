        ...
        <div id="roomchat1">
          ...
          <div class="row py-3 mt-0 rounded-top" style="background-color: #A78295;">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                <h6 class="mb-1 text-white" id="name" style="font-size: 16px; font-weight: 600;">Fabian Greyson</h6>
          ...
          <!-- background -->
          <div class="row py-3 align-self-start" id="roomchat" style="background-color: #E2D2DA; overflow-y: auto; height:500px">
          </div>
